 ...
 */
package de.hybris.mymod.fulfilmentprocess.test.jobs;
...
import de.hybris.mymod.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MymodFulfilmentProcessConstants.ORDER_PROCESS_NAME;
