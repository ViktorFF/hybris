 ...
 */
package de.hybris.mymod.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MymodFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MymodFulfilmentProcessConstants.PARENT_PROCESS);
