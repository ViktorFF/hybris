 ...
 */
package de.hybris.mymod.core.constants;

/**
 * Global class for all MymodCore constants. You can add global constants for your extension into this class.
 */
public final class MymodCoreConstants extends GeneratedMymodCoreConstants
{
	public static final String EXTENSIONNAME = "mymodcore";


	private MymodCoreConstants()
	{
		//empty
	}
