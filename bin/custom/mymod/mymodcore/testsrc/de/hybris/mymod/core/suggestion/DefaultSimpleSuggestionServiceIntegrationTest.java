 ...
 */
package de.hybris.mymod.core.suggestion;
...
import de.hybris.mymod.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/mymodcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
