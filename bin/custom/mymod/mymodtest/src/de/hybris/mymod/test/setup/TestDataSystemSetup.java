 ...
 */
package de.hybris.mymod.test.setup;
...
import de.hybris.mymod.test.constants.MymodTestConstants;
import de.hybris.mymod.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MymodTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mymodtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mymodtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mymodtest/import/cstickets.impex");
			...
			importImpexFile(context, "/mymodtest/import/csquotes.impex");
		}
	}
}
