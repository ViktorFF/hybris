...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mymodstorefront/electronics/en",
						"https://electronics.local:9002/mymodstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mymodstorefront/electronics/en",
						"https://electronics.local:9002/mymodstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mymodstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mymodstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mymodstorefront/electronics/en",
						"https://electronics.local:9002/mymodstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mymodstorefront",
						"https://electronics.local:9002/mymodstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mymodstorefront",
						"https://electronics.local:9002/mymodstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mymodstorefront/electronics/en",
						"https://electronics.local:9002/mymodstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
